#plot4: function to read the read the data and plot 1st plot
plot4 <- function ()
{
    ...
    plot(elecData$Time, elecData$Voltage, type= 'l', xlab = "datetime", 
         ylab = "Voltage")
    ...
    plot(elecData$Time, elecData$Global_reactive_power, type= 'l', xlab = "datetime", 
